 ...
 */
public class HdfsFtpServerFactory {
     ...
     * @throws Exception
     */
    public HdfsFtpServerFactory() {
        serverContext = new DefaultFtpServerContext();
    }

    /**
     * Create a {@link HdfsFtpServer} instance based
     *   on the provided configuration and JMX domain
     * @return The {@link HdfsFtpServer} instance
     */
    public FtpServer createServer(String jmxdomain, String mbeanname) {
        return new HdfsFtpServer(serverContext, jmxdomain, mbeanname);
    }
